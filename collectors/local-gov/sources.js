...
const COMMON_INCLUDE_REGEX =
  /(입찰공고|입찰|입찰에\s*부치는\s*사항|용역|제안서|제안요청서|제안서\s*평가위원|평가위원(\s*\(후보자\))?|공개\s*모집|모집\s*공고|위탁운영기관\s*모집|수탁기관\s*모집|운영기관\s*모집|사업자\s*모집|수행기관|수행주체\s*모집|참여기관\s*모집|기술제안|협상에\s*의한\s*계약|안전점검\s*수행기관|민간위탁|지정\s*공고|제안서\s*제출|가격입찰서|일반공개경쟁입찰)/i;
  ...
  sources: [
    {
      ...
      include_regex:
        /(입찰공고|입찰|입찰에\s*부치는\s*사항|용역|제안서|제안요청서|제안서\s*평가위원|평가위원(\s*\(후보자\))?|공개\s*모집|모집\s*공고|수탁기관\s*모집|위탁운영기관\s*모집|운영기관\s*모집|사업자\s*모집|수행기관|수행주체\s*모집|참여기관\s*모집|안전점검\s*수행기관|민간위탁|지정\s*공고|제안서\s*제출|가격입찰서|일반공개경쟁입찰)/i,
      exclude_regex: COMMON_EXCLUDE_REGEX,
...

    {
      ...
      include_regex:
        /(입찰공고|입찰|입찰에\s*부치는\s*사항|용역|제안서|제안요청서|평가위원(\s*\(후보자\))?|모집\s*공고|위탁운영기관\s*모집|운영기관\s*모집|수탁기관|공개\s*모집|사업자\s*모집|수행기관|안전점검\s*수행기관|민간위탁|지정\s*공고)/i,
      exclude_regex:
...

    {
      ...
      include_regex:
        /(제안서|제안요청서|제안서\s*평가위원|평가위원(\s*\(후보자\))?|공개\s*모집|모집\s*공고|용역|입찰공고|입찰|기술제안|제안서\s*제출|협상에\s*의한\s*계약)/i,
      exclude_regex: COMMON_EXCLUDE_REGEX,
...

    {
      ...
      include_regex:
        /(용역|입찰|제안서|제안요청서|제안서\s*평가위원|평가위원(\s*\(후보자\))?|공개\s*모집|모집\s*공고|수탁기관\s*모집|운영기관\s*모집|민간위탁|제안서\s*제출)/i,
      exclude_regex:
...

    {
      ...
      include_regex:
        /(입찰공고|입찰|입찰에\s*부치는\s*사항|용역|제안서|제안요청서|제안서\s*평가위원|평가위원(\s*\(후보자\))?|공개\s*모집|모집\s*공고|협상에\s*의한\s*계약|민간위탁|제안서\s*제출|가격입찰서|일반공개경쟁입찰|모아타운)/i,
      exclude_regex:
        /(평가결과|선정결과|개찰결과|낙찰자|우선협상대상자|결과\s*공고|합격자|채용공고)/i,
...

    {
      ...
      include_regex:
        /(입찰공고|입찰|입찰에\s*부치는\s*사항|용역|제안서|제안요청서|평가위원(\s*\(후보자\))?|공개\s*모집|모집\s*공고|사업자\s*모집|운영기관\s*모집|수행기관|안전점검\s*수행기관|민간위탁|지정\s*공고|제안서\s*제출|가격입찰서)/i,
...

    {
      ...
      include_regex:
        /(용역|입찰|제안서|제안요청서|제안서\s*평가위원|평가위원(\s*\(후보자\))?|공개\s*모집|모집\s*공고|수탁기관\s*모집|운영기관\s*모집|민간위탁|숲해설|유아숲)/i,
      exclude_regex:
        /(평가결과|선정결과|개찰결과|낙찰자|우선협상대상자|결과\s*공고|합격자|채용공고)/i,
...

    {
      ...
      include_regex:
        /(입찰공고|입찰|입찰에\s*부치는\s*사항|용역|제안서|제안요청서|제안서\s*제출|가격입찰서|일반공개경쟁입찰|협상에\s*의한\s*계약|민간위탁|지정\s*공고)/i,
      exclude_regex:
        /(평가결과|선정결과|개찰결과|낙찰자|우선협상대상자|결과\s*공고|합격자|채용공고)/i,
