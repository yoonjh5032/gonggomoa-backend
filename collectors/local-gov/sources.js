...
const COMMON_EXCLUDE_REGEX =
  /(평가결과|선정결과|개찰결과|낙찰자|낙찰\s*결과|우선협상대상자|우선협상대상자\s*선정|협상\s*결과|결과\s*공고|합격자|최종합격|채용공고|채용\s*재공고|기간제근로자\s*채용|임기제공무원\s*채용|행정처분|영업정지|등록취소|공시송달|반송분\s*공시송달|의견청취|청문|과태료|처분\s*사전통지|회의록|심의록|속기록|녹취록|위원회\s*회의록|의회\s*회의록|간담회\s*결과|결과보고서|사업결과보고서?|연구보고서|연구용역\s*결과보고서?|용역\s*결과보고서?|최종보고서|중간보고서|성과보고서|감사결과보고서?|업무보고|주간업무(?:계획|보고)?|월간업무(?:계획|보고)?|백서)/i;
